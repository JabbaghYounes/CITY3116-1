...
def main():
    ...
    print()
    print("  Next steps:")
    print("  1. Wait 15s for final flows to expire and get classified")
    print("  2. Take screenshots of each tmux pane (if desired)")
    print("  3. Ctrl+C the IDS Monitor pane    (top-right)")
    print("  4. Ctrl+C the tcpdump pane         (bottom-left)")
    print("  5. Ctrl+C the dashboard pane        (top-left)")
    print()
