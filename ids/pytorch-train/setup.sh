...
#!/usr/bin/env bash
source "$VENV_DIR/bin/activate"
# RX 7900 XT (gfx1201 / RDNA 4) may need this for ROCm compatibility:
...
echo "  source env.sh"
echo ""
echo "Training commands (run from ids/pytorch-train/):"
echo ""
...
echo ""
echo "For AMD RX 7900 XT, if GPU isn't detected, try:"
